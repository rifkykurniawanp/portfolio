...
export const certifications: Certification[] = [
  ...
  },
  {
    ...
    logo: "/logo/institusi/perki.png",
    date: "May 2025",
    images: [
      { src: "/picture/certificated/acls-certificate.webp", label: "Certificate" },
    ],
    activityImages: [
  ...
  },
  {
    ...
    logo: "/logo/institusi/osi.png",
    date: "July 2025",
    images: [
      { src: "/picture/certificated/osi-certificate.webp", label: "Certificate" },
    ],
    activityImages: [
...
export const techSkills: TechSkill[] = [
  { name: "Html", icon: "/logo/skillset/html.png" },
  { name: "css", icon: "/logo/skillset/css.png" },
  { name: "tailwind", icon: "/logo/skillset/tailwind.png" },
  { name: "JavaScript", icon: "/logo/skillset/javascript.svg" },
  { name: "TypeScript", icon: "/logo/skillset/typescript.svg" },
  { name: "React", icon: "/logo/skillset/react.svg" },
  { name: "Next.js", icon: "/logo/skillset/nextjs.svg" },
  { name: "Nest.js", icon: "/logo/skillset/nestjs.svg" },
  { name: "Node.js", icon: "/logo/skillset/nodejs.png" },
  { name: "PostgreSQL", icon: "/logo/skillset/postgree.svg" },
  { name: "Supabase", icon: "/logo/skillset/supabase.png" },
  { name: "Postman", icon: "/logo/skillset/postman.png" },
  { name: "prismaORM", icon: "/logo/skillset/prisma-orm.png" },
  { name: "Vercel", icon: "/logo/skillset/vercel.png" },
]
