  ...
  return (
    <div className="flex flex-1 flex-col" {...rest}>
      <div className={cn("w-full", stepCircleContainerClassName)}>
        ...
        {/* Step indicators */}
        <div className={cn("flex w-full items-center px-8 pt-8 pb-4", stepContainerClassName)}>
        ...
        <StepContentWrapper
          ...
          currentStep={currentStep}
          direction={direction}
          className={cn("px-8", contentClassName)}
        >
            ...
            <div className={cn(
              ...
              <button
                ...
                className={cn(
                  ...
                  "bg-[#5227FF] hover:bg-[#4318d4] active:bg-[#3510b8]",
                  "py-1.5 px-5 text-sm font-medium tracking-tight text-white",
