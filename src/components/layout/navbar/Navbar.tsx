  ...
  return (
    <nav className={cn(
      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <Link
          href="/"
          className="font-bold text-lg tracking-tighter text-foreground transition-opacity hover:opacity-70"
        >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            className="md:hidden p-2 text-muted-foreground hover:text-[#5227FF] transition-colors"
          ...
          >
            <div className="w-6 h-5 flex flex-col justify-between items-end">
              <span className={cn(
                ...
                open ? "w-6 translate-y-[9px] rotate-45" : "w-6"
              )} />
              <span className={cn(
                "h-[2px] bg-current rounded-full transition-all duration-300",
                open ? "opacity-0" : "w-4"
              ...
              <span className={cn(
                "h-[2px] bg-current rounded-full transition-all duration-300",
                open ? "w-6 -translate-y-[9px] -rotate-45" : "w-5"
              )} />
            </div>
          </button>
        </div>
