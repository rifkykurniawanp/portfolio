  ...
  return (
    ...
    >
      <body className="relative antialiased bg-neutral-50 text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
        ...
        {/* Background - static, di luar ThemeProvider agar tidak ikut bail out */}
        ...
        >
          {/* Semua client-only stuff (MagicCursor, PageLoader, Toaster, HashScroll) */}
          <ClientProviders />

          <Navbar name="Rifky Kurniawan Putra" items={navItems} />

          <main className="relative z-10 mx-auto max-w-6xl px-6 py-8">
            <div className="rounded-2xl p-6 md:p-10 border border-white/30 dark:border-white/10 bg-white/60 dark:bg-neutral-900/50 backdrop-blur-md shadow-xl shadow-black/5 dark:shadow-black/30 ring-1 ring-inset ring-white/40 dark:ring-white/5">
              {children}
            </div>
          </main>
        ...
        {/* Pindah ke dalam body — sebelumnya di luar <html> yang invalid */}
        <Analytics />
        <SpeedInsights />
